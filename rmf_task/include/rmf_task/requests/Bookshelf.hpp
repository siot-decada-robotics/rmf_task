...
#ifndef RMF_TASK__REQUESTS__BOOKSHELF_HPP
#define RMF_TASK__REQUESTS__BOOKSHELF_HPP
...
//==============================================================================
/// A class that generates a Request which requires an AGV to perform a bookshelf scanning
...
public:
  ...
  /// Generate a bookshelf request
  ///
  /// \param[in] start_waypoint
  ///   The graph index for the location where the AGV should begin its bookshelf scanning
  ///   operation
  ///
  /// \param[in] end_waypoint
  ///   The graph index for the location where the AGV ends up after its bookshelf scanning
  ///   operation
  ///
  /// \param[in] bookshelf_path
  ///   A trajectory that describes the motion of the AGV during the bookshelf_scanning
...
#endif // RMF_TASK__REQUESTS__BOOKSHELF_HPP
